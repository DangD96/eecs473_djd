// David Dang djd122
// 10/1/18
// action_server_class.h header file 
...
#ifndef ACTION_SERVER_CLASS_H_
#define ACTION_SERVER_CLASS_H_
...
class ActionServerClass
{
public:
    ActionServerClass(ros::NodeHandle* nodehandle); //"main" will need to instantiate a ROS nodehandle, then pass it to the constructor
