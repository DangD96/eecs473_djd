...
int main(int argc, char **argv) {
	...
	/*ROS_INFO("Finished: According to logical camera, z-value of box when conveyor halted was: "<<g_cam2_data.models[0].pose.position.z<<endl);*/ 
