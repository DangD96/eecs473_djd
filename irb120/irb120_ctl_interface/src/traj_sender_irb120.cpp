...
{
    // ROS set-ups:
    ros::init(argc, argv, "traj_sender_irb120"); //node name
...
0, 1.4,0.6
*/    
     trajectory_point1.positions[0] = 0.0;
     trajectory_point1.positions[1] = 1.5;
     trajectory_point1.positions[2] = 0.0;
     
     trajectory_point2.positions[0] = 0.0;
     trajectory_point2.positions[1] = 0.0;
     trajectory_point2.positions[2] = 0.0;
     
     trajectory_point3.positions[0] = 5.0;
     trajectory_point3.positions[1] = 0.0;
     trajectory_point3.positions[2] = 5.0;
     
     trajectory_point4.positions[0] = 5.0;
     trajectory_point4.positions[1] = 1.5;
     trajectory_point4.positions[2] = 0.0;
     
     trajectory_point5.positions[0] = 7.0;
     trajectory_point5.positions[1] = 0.0;
     trajectory_point5.positions[2] = 0.0;
     
     trajectory_point6.positions[0] = 7.0;
